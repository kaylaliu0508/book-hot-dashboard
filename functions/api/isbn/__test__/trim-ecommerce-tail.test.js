...
const cases = [
  ...
  // ============ 🆕 三段式标题（当当典型场景）============
  ['我是中国人 所以我知道 中国学生必会的名著考点2000问', '我是中国人 所以我知道', '3 段：主+副+系列描述 → 保留主+副'],
  ['活着 就是要好好活着 余华代表作系列', '活着 就是要好好活着', '3 段：主+副+作家描述 → 保留主+副'],
  ['育儿百科 0-6岁宝宝养育指南 适合新手父母', '育儿百科', '3 段，但第 2 段含"0-6岁"已是电商卖点 → 只取主标'],
  ['哈利波特 全7册 中文版精装套装', '哈利波特', '3 段，第 2 段是"全7册" → 只取主标'],
  // 主+副超过 16 字：只取主标
  ['超长主标在这里啊 副标题也很长很长很长 第三段电商', '超长主标在这里啊', '3 段，主+副拼起来 21 字 > 16 → 只取主标'],
];
