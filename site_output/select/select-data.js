...
const DEEP_CATS = [
  ...
  {role:'基本盘', name:'教辅 · 衔接预备预习', icon:'🔗', headClass:'basic', cat:'教辅',
    ...
    tips:[
      ...
      '<strong>组品逻辑</strong>：主推语数英三本套（¥99-129）→ 加印开学计划表/错题本附赠拉客单到 ¥139-159 主带'
    ]},
  {role:'机会盘', name:'教辅 · 重难点专项提升', icon:'🎯', headClass:'opportunity', cat:'教辅',
    ...
    tips:[
      '<strong>选品思路</strong>：暑期需求集中在弱科补习与强科拔高，专项书是高决策刚需',
      '<strong>核心需求</strong>：家长关注开学前的薄弱科目专项练习，按学科切分清晰',
      '<strong>组品策略</strong>：单科 ¥69-99 引流 → 3 科套装 ¥199-299 主推（核心客单带），高考冲刺旗舰套 ¥399-499 直购溢价'
    ]},
  {role:'潜力品', name:'教辅 · 工具书（字帖/单词/速记）', icon:'📔', headClass:'potential', cat:'教辅',
    ...
    tips:[
      '<strong>选品思路</strong>：决策路径短，沉浸观看 → 即点即购，重点用组品/套装拉升客单',
      '<strong>核心需求</strong>：家长希望孩子假期保持基础练习节奏，单本难溢价、系列化是关键',
      '<strong>客单引导</strong>：避免单本 ¥19-29 引流款独立铺量，主推 6 本字帖大礼包 ¥69-99、12 册单词速记套装 ¥99-129、年级全套 ¥149 主带 50-150 元客单区间'
    ]},
  // ========= 童书 3 卡 =========
