...
const MONTHS_DATA = [
  ...
  {m:'8月',  total:63, 教辅:22, 童书:11, 健康:13, 社科:17, season:'暑期收官+开学倒计时', focus:'教辅收官续单+开学抢跑，童书入学准备，健康秋季食补启动', current:true},
...
const WEEK_RHYTHM_AUG = {
  weeks: [
    { key:'W1', summer:'暑期收官 · 开学倒计时全月化', festival:'',              date:'8.1-8.6' },
    { key:'W2', summer:'立秋 · 开学冲刺爆发期',        festival:'立秋 8/7',      date:'8.7-8.13' },
    { key:'W3', summer:'开学决策高峰 · 秋季主题起势',  festival:'',              date:'8.14-8.22' },
    { key:'W4', summer:'开学季峰值 + 秋季消费主线切换', festival:'处暑 8/23',     date:'8.23-8.31' }
  ],
  rows: [
    {
      cat:'教辅', icon:'📖', priority:'P0', colorClass:'wr-cat-color-jiaofu',
          ...
          groups: [
            {
              title:'📚 开学倒计时（多学段续单主线）',
              items: [
                '幼小：入学准备最后一公里（拼音 / 20 以内加减 / 看图说话收官）',
                '小学：暑假作业收尾 + 新学期预习（人教版/北师大版分册）',
                '初高中：开学摸底卷 / 错题归纳 / 新学期一本通'
              ],
              pain:'家长怕"开学摸底掉队"——摸底卷 + 错题本双件套成为家长安全感必选，8 月是全学段最确定的续单窗口'
            },
            {
              title:'🎓 衔接末班车（准新初一/准新高一收官）',
              items: [
                '准新初一：分班考押题 / 小升初衔接教材',
                '准新高一：预备高一 / 数理化衔接 / 英语词汇',
                '准新一：识字大礼包 / 幼小衔接一日一练'
              ],
              pain:'"再不衔接就来不及"——8 月是衔接类最后决策窗口，家长焦虑值达到暑期最高峰，是教辅第二基本盘'
            }
          ],
          lead:'⏰ 8/1 起「开学倒计时」全线放量，衔接类进入最后决策窗口'
        },
        {
          week:'W3', span:1,
          groups: [
            {
              title:'🔥 高中一轮复习加速 + 非K12 承接',
              items: [
                '高中：一轮复习专项 / 五三 / 高考真题解析',
                '状元笔记 / 学霸提分错题',
                '非K12：四六级冲刺 / 考研强化 / 教资'
              ],
              pain:'高中一轮复习进入 8 月中真正提速期；非K12 借开学季"新学期新计划"心智完成决策——两者都是高客单强付费人群'
            }
          ],
          lead:'☀️ 8 月中一轮复习正式加速；非K12 借"新学期"心智收单'
        },
        {
          week:'W4', span:1,
          groups: [
            {
              title:'🎒 开学季峰值 + 分班考押题',
              items: [
                '各学段：开学第一课 / 摸底卷密卷 / 分班考真题',
                '教辅工具套装：错题本 / 笔记本 / 便签本',
                '小初高全学段：新学期一本通 / 新学期口算'
              ],
              pain:'8/25-8/31 开学日临近，家长冲动决策强，是教辅全年第二高峰（仅次于开学后 9 月）'
            }
          ],
          lead:'📝 8/25-8/31 开学季峰值，量能延续至 9 月中'
        }
      ]
    },
    {
      ...
      cells: [
        {
          ...
          groups: [
            {
              title:'🎒 入学准备 + 习惯养成（整月主线 · 开学季刚需）',
              items: [
                '入学准备心理建设 / 自理能力绘本（穿衣 / 系鞋带 / 收拾书包）',
                '好习惯养成 / 时间管理 / 专注力训练',
                '情绪管理 / 社交礼仪 / 校园人际启蒙'
              ],
              pain:'准小一/低龄妈妈"开学焦虑"——怕孩子在学校自理不好、不合群，8 月是入学准备类童书最确定的高峰'
            },
            {
              title:'🌱 上半月承接 — 内驱力 + 财商启蒙（家长「暑期结束前最后教育窗口」）',
              items: [
                '思维启蒙 / 财商启蒙 / 内驱力培养',
                '为人处世 / 礼仪教养',
                '情商成长 / 心理 / 情绪管理'
              ],
              pain:'30-45 岁妈妈"暑假快结束了，我给娃教了啥？"—— 8 月上是家长补课式教育类童书决策窗口'
            },
            {
              title:'📖 下半月承接 — 阅读积累冲刺（暑期读书量清单交作业）',
              items: [
                '经典儿童文学套装 / 世界名著少儿版',
                '语文课标必读 / 小学生必读书目',
                '科普百科套装 / 国学启蒙套装'
              ],
              pain:'开学要交"暑假阅读书目"作业——家长下半月补量冲刺，套装决策集中'
            }
          ],
          lead:'⏰ 入学准备整月贯穿；内驱/财商上半月抢决策、阅读套装下半月冲量'
        }
      ]
    },
    {
      ...
      cells: [
        {
          ...
          groups: [
            {
              title:'💰 赚钱创富选题（整月主线 · 长青大盘）',
              items: [
                '副业实操 / 个人 IP 打造 / 短视频变现',
                '投资理财入门 / 商业谋略 / 翻盘逆袭',
                '成事谋略 / 草根逆袭 / 商业人物传记'
              ],
              pain:'25-40 岁打工人「下半年逆袭」心智+「搞钱副业」长青诉求；立秋后消费者进入"总结上半年 / 冲刺下半年"心理周期'
            },
            {
              title:'💼 上半月承接 — 职场表达 & 人际沟通',
              items: [
                '沟通表达 / 高情商对话 / 接话回话',
                '向上管理 / 跨部门协作 / 演讲汇报',
                '提问的力量 / 说话之道'
              ],
              pain:'25-35 岁职场新人"人际困境"高频，8 月上是社科稳态承接盘'
            },
            {
              title:'🏛 下半月承接 — 国学智慧 · 古为今用',
              items: [
                '为人处世智慧（古人谋略 / 家训类）',
                '帝王家训 / 家书家训',
                '古典哲学落地（白话解读实用版）'
              ],
              pain:'家长想"给娃做文化启蒙"；打工人想"用古人智慧解现代焦虑"—— 8 月下承接开学季文化心智'
            }
          ],
          lead:'⏰ 赚钱创富整月贯穿；职场表达上半月铺底、国学智慧下半月承接'
        }
      ]
    },
    {
      ...
      cells: [
        {
          week:'W1', span:4,
          direction:'秋季食补主题启动（立秋贴秋膘 / 处暑润燥 / 秋季家常菜 / 24 节气食谱 / 阳台养生种植）',
          pain:'家庭主理人"立秋后要给家人补一补"—— 秋膘 / 润燥是最强节气心智；秋季家常菜是家庭主理人 8 月最刚需的高频决策',
          lead:'⏰ 全月铺底款，立秋 8/7 + 处暑 8/23 双节气双峰启动秋季主题'
        }
      ]
    }
  ]
...
const WEEK_RHYTHM_MONTHS = [
  { key:'2026-08', label:'8 月',  sublabel:'当期', data: WEEK_RHYTHM_AUG  },
...
// ===== 默认当月切换：7/31 起切到 8 月（原逻辑保留，兼容不打开 tab 场景）=====
  ...
  '2026-07-13': [
    {
      ...
      creativeCore:'首次登榜即直冲 #1，日销 20-30W 挤到最高档、转化 6.6-7.6% 全场靠前。**唯一小程序渠道的 Top10 爆款**——付费人群仍是家长（准高一/高二/高三妈妈）为主，孩子越靠近升学、家长为"提分/冲刺"付费的意愿越强 × 暑期冲刺窗口 × 二级结论"秒解"卖点直击家长提分焦虑。建议加码放量，创意主打「一页公式抵一本资料」的效率对比 + 学霸口述"考场原题套结论"实证，落点在"帮孩子省时间、家长少焦虑"',
  ...
  '2026-07-06': [
    {
      ...
      persona:'6-15 岁孩子的妈妈（关注语文素养、阅读积累）',
      creativeCore:'6/1 起连续 6 周稳居 #1，本周日销从 20-30W 略回落到 10-20W，转化仍稳定在 5-6%。暑期档语文素养刚需盘持续释放，建议维持采访学霸抽问形式，通过「同龄人都会 vs 我家孩子答不上」的信息差焦虑持续渗透',
      creativeWarning:'⚠️ 不可拍摄孩子答错时的难堪表情，避免负面对比'
    },
    {
      role:'#2 童书·幼小衔接 · 转化爆发',
      ...
      creativeCore:'关键跃升：转化率从上周 2.8-3.8% 直冲到 9.8-10.9%（翻 3 倍），排名 #3→#2 再进一位，暑期幼升小刚需完全兑现。可加码放量试试，创意延续「暑期 60 天衔接方案」但更聚焦近端行动，让家长看到"9 月开学不慌"的可信节奏'
    },
    {
      role:'#3 教辅·初中物理 · 霸榜劲品',
      roleClass:'basic',
      ...
      persona:'准初一 / 初二孩子的妈妈（预习初中物理、消除畏难情绪）',
      creativeCore:'4/20 起连续在榜 11 周（历史最高名次 #3），暑期是预备初一/初二关键窗口。漫画形式降低物理入门门槛，主打「暑假抢跑一步 → 开学不畏难」情绪，配合近期"初中必背古诗+文言文"衔接类爆款组合投放'
    }
  ],
