...
const WEEK_RHYTHM = {
  weeks: [
    { key:'W1', name:'六一儿童节', date:'6.1-6.7' },
    { key:'W2', name:'高考',       date:'6.7-6.13' },
    { key:'W3', name:'端午节',     date:'6.14-6.21' },
    { key:'W4', name:'期末+暑期预热', date:'6.22-6.30' }
  ],
  rows: [
    {
      ...
      cells: [
        {
          ...
          groups: [
            ...
            },
            {
              ...
              pain:'小初家长发现"娃读了不少题，但提笔没词、单词记不住、公式套不准"；期末前想给娃找"短平快提分捷径"'
            }
          ],
          lead:'⏰ 志愿类：高考前 1 个月（5/7）开跑，6/9 查分起进入决策高峰；学科工具书：6/10 起进入期末冲刺前置期，"知识点速记"搜索同比 +85%，可贯穿到 W3-W4'
        },
        // W3+W4 拉通：期末冲刺 + 暑期衔接（跨 2 周）
        {
          week:'W3', span:2,
          groups: [
            {
              ...
              pain:'小学家长怕"考砸开学被甩开"；初中家长焦虑"分章节查漏 + 错题没归纳"'
            },
            {
              title:'☀️ 暑期衔接',
              items: [
              ...
              pain:'幼小衔接家长焦虑"识字少 / 坐不住"；小升初家长怕"初一掉队"；高一/高二怕"暑期不衔接 秋季掉队"'
            }
          ],
          lead:'⏰ 6/15 起进入需求高峰，6/22 起期末冲刺 + 暑期衔接双爆发，持续到 8 月'
        }
      ]
    },
    {
...
const HOT_BOOK_BREAKDOWN = [
  {
    ...
    sellingPoints:[
      ...
      {icon:'💎', label:'价位', val:'¥89-159 适配节日送礼'},
      {icon:'👥', label:'人群', val:'妈妈自购 + 长辈送礼共振'}
    ]
  },
  {
    role:'#2 社科·家居生活',
  ...
  },
  {
    ...
    sellingPoints:[
      ...
      {icon:'📚', label:'组套', val:'¥399-499 组套溢价合理'},
      {icon:'☀️', label:'节奏', val:'承接 6 月期末 + 暑期复习'}
    ]
  }
];
