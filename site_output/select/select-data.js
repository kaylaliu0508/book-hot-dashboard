...
const MONTHS_DATA = [
  ...
  {m:'6月',  total:90, 教辅:40, 童书:30, 健康:10, 社科:20, season:'考试季·暑期', focus:'教辅暑期衔接+期末冲刺主线', current:true},
          ...
          groups: [
            {
              ...
              pain:'高三家长怕"分数浪费 / 不会填志愿 / 选错专业"；高一/高二家长担心"提前 2 年规划晚不晚"'
            },
            {
              title:'📝 小初学科工具书 + 暑期预习预热',
              items: [
                '作文金句素材 / 英语单词速记 / 数学公式口诀',
                '古诗文逐句精讲 / 易错字词手册',
                '暑期预习类：小升初分班题 / 初一预备 / 高一提升'
              ],
              pain:'小初家长怕"娃读了不少题但提笔没词、单词记不住、公式套不准"；同时焦虑"暑期不规划 秋季掉队"，提前找暑期预习方向'
            }
          ],
          lead:'⏰ 志愿类：高考前 1 个月（5/7）开跑，6/9 查分起进入决策高峰；学科工具书 + 暑期预习类：6/1 起暑期预热前置铺品，"暑期预习 / 衔接"搜索同比 +85%，可一直贯穿到 W4'
        },
        // W3 暑期核心放量期 + W4 期末+暑期稳定期
        {
          week:'W3', span:1,
          groups: [
            {
              title:'☀️ 暑期衔接（核心放量）',
              items: [
                '幼小衔接：识字 / 拼音 / 20 以内加减法 / 习惯养成',
                '小初衔接：小升初分班 / 初一预备（数学几何 / 英语语法）',
                '初高衔接：初升高预备 / 高一提升类（理科基础 / 英语词汇）'
              ],
              pain:'幼小衔接家长焦虑"识字少 / 坐不住"；小升初家长怕"初一掉队"；高一/高二怕"暑期不衔接 秋季掉队" — 端午前后家长开始密集搜索暑期方案'
            }
          ],
          lead:'☀️ 端午节后（6/15）暑期衔接进入核心放量期，搜索峰值持续 4-6 周，全品类暑期衔接是 6 月教辅最大爆款带'
        },
        {
          week:'W4', span:1,
          groups: [
            {
              title:'📝 期末冲刺 + 暑期稳定续单',
              items: [
                '期末冲刺试卷 / 模拟卷 / 错题归纳本 / 分章节查漏',
                '暑期稳定爆款：暑假作业本 / 阅读打卡 / 衔接类续单'
              ],
              pain:'小学家长怕"考砸开学被甩开"；初中家长焦虑"分章节查漏 + 错题没归纳"；考完后立即转向暑假作业 / 衔接类续单'
            }
          ],
          lead:'📝 6/22 期末冲刺爆量 1 周，6/30 后立即切换暑期稳定期 — 暑假作业 + 衔接续单，量稳到 8 月底'
        }
      ]
    },
    {
      ...
      cells: [
        {
          week:'W1',
          direction:'趣味亲子阅读 · 六一送礼：立体书 / 科普百科 / 漫画国学',
          pain:'3-12 岁家长想"既哄娃开心又有教育意义"；55+ 长辈"代际给孙辈表心意"找不到合适礼物',
          lead:'⏰ 5/15 进入选品观察期，5/20-25 全面铺品，6/1 当日转化'
        },
        // W2-W4 跨 3 周，作为持续主题
        {
          week:'W2', span:3,
          groups: [
            {
              ...
              items: [
                '文化常识 / 国学启蒙',
                '科普百科 / 自然探索',
                '趣味学科素养储备（数学思维 / 阅读理解 / 英文分级）'
              ],
              pain:'家长怕暑期"光玩不学"；幼小衔接家长焦虑"识字少 / 坐不住"；中年级家长想"假期弯道超车"'
            },
            {
              title:'🌱 成长教育童书',
              items: [
              ...
              pain:'中年级家长发现"孩子叛逆 / 内驱力差 / 不会处理情绪"；高知妈妈追求"软实力培养"'
            }
          ],
          lead:'⏰ 6/8 起持续铺品，配合暑期前 30 天搜索高峰（同比 +40%）'
        }
      ]
    },
    {
      ...
      cells: [
        {
          week:'W1', span:2,
          direction:'职场提升工具书：沟通表达 / 思维方法 / 副业理财',
          pain:'25-40 岁职场人焦虑"年中 KPI 还差一截"；高知白领"自我增值 + 文化身份"双重需求',
          lead:'⏰ 5/25 起步，6 月上旬持续，配合"年中复盘"心智'
        },
        {
          week:'W3', span:2,
          direction:'传统国学经典："古为今用"系列解读 + 烫金线装精装礼盒，主打古人智慧的现代实操性',
          pain:'30-45 岁家庭妈妈想"给娃做文化启蒙又拿不准书"；25-35 高知白领追求"用古人智慧解决现代焦虑"——职场内卷、人际关系、情绪管理；端午节礼场景下追求"礼物有文化感、不俗气"',
          lead:'⏰ 端午前 10 天（6/9）起步，搜索高峰同比 +156%，礼盒版库存提前备齐；古为今用解读类可贯穿到 W4'
        }
      ]
    },
    {
      ...
      cells: [
        {
          week:'W1', span:4,
          direction:'夏季健康食谱（轻食 / 减糖 / 24 节气）+ 家庭饮食搭配 + 中老年膳食健康管理',
          pain:'30-50 岁家庭主理人"夏天没胃口、又怕娃营养跟不上"；中老年人群关注"科学饮食 / 膳食搭配"长期复购需求；年轻女性"夏日体态管理 / 抗衰"刚需',
          lead:'⏰ 全月铺底款（基本盘），6 月气温升高自然搜索增长，节气食谱 6/5（芒种）+ 6/21（夏至）双峰'
        }
      ]
    }
  ]
...
const DEEP_CATS = [
  ...
  {role:'基本盘', name:'教辅 · 衔接预备预习', icon:'🔗', headClass:'basic', cat:'教辅',
    ...
    tips:[
      '<strong>选品思路</strong>：围绕升学过渡期的预习需求做组品',
      '<strong>核心需求</strong>：家长关注新学段衔接的适应感',
      '组品逻辑：新年级语数英三本套（¥99-159）+ 开学计划表附赠',
      '<strong>季节节奏</strong>：6月幼小/初升高启动，7月小升初铺量，8月延续'
    ]},
  {role:'机会盘', name:'教辅 · 重难点专项提升', icon:'🎯', headClass:'opportunity', cat:'教辅',
    ...
    tips:[
      '<strong>选品思路</strong>：暑期需求集中在弱科补习与强科拔高',
      '<strong>核心需求</strong>：家长关注开学前的薄弱科目专项练习',
      '组品策略：单科 ¥69-99，3 科套装 ¥199-299',
      '6/20 暑假启动 → 7月专项突击 → 8月模考节奏三段铺量'
    ]},
  {role:'潜力品', name:'教辅 · 工具书（字帖/单词/速记）', icon:'📔', headClass:'potential', cat:'教辅',
    stats:'15w/d · cvr 13.8%',
    sellingPoint:'⭐ 短视频信息流直购为主 · 转化效率较高、客单较低',
    subCats:['硬笔字帖（暑假练字 30天系列）','英语单词速记（思维导图/词根词缀）','古诗词100首速记/小古文','公式定理大全/错题本'],
    tips:[
      '<strong>选品思路</strong>：客单较低、决策路径短，沉浸观看 → 即点即购',
      '<strong>核心需求</strong>：家长希望孩子假期保持基础练习节奏',
      '<strong>转化表现</strong>：cvr 13.8% 在教辅子赛道相对领先，¥9.9-29.9 决策门槛较低',
      '组品+套装拉升客单价（单本¥19 → 套装¥99），系列化承接复购'
    ]},
  // ========= 童书 3 卡 =========
